...
export const pilotGalleries: Record<string, PilotGallery> = {
  pergamino: {
    ...
    gallery: [
      ...
      {
        src: '/pilots/pergamino-lst-map.png',
        alt: 'Land surface temperature map of Pergamino showing heat distribution',
        caption: 'Land surface temperature analysis revealing urban heat islands',
        author: 'Nissim Lebovits / Human Scale Data',
        license: 'cc-by-4.0',
        sourceUrl: 'https://human-scale-data.org/pilots/pergamino',
        date: '2025-11-15',
      },
      {
        src: '/pilots/pergamino-pop-exposure.png',
        alt: 'Population heat exposure map of Pergamino',
        caption: 'Total population exposure to extreme heat by census block',
        author: 'Nissim Lebovits / Human Scale Data',
        license: 'cc-by-4.0',
        sourceUrl: 'https://human-scale-data.org/pilots/pergamino',
        date: '2025-11-15',
      ...
      {
        src: '/pilots/pergamino-vuln-exposure.png',
        alt: 'Vulnerable population heat exposure map of Pergamino',
        caption: 'Vulnerable population (elderly, children) exposure to extreme heat',
        author: 'Nissim Lebovits / Human Scale Data',
        license: 'cc-by-4.0',
        sourceUrl: 'https://human-scale-data.org/pilots/pergamino',
        date: '2025-11-15',
      ...
      {
        src: '/pilots/pergamino-canopy.png',
        alt: 'Tree canopy coverage map of Pergamino',
        caption: 'Urban tree canopy distribution showing cooling potential',
        author: 'Nissim Lebovits / Human Scale Data',
        license: 'cc-by-4.0',
        sourceUrl: 'https://human-scale-data.org/pilots/pergamino',
        date: '2025-11-15',
